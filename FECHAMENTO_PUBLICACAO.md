...
- PIN da demo: `1234`
- Versao atual dos assets: `20260602-polish11`
- Service worker atual: `team-lucao-v31`
...
- Entrar com PIN `1234`.
- Verificar se o rodape mobile mostra `Inicio`, `Alunos`, `Aulas`, `Cobrar`, `Espera`, `Mais`.
- Confirmar que a tela de login nova aparece.
