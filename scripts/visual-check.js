...
const expectedAssetVersion = process.env.VISUAL_CHECK_VERSION || '20260611-flow40';
const expectedPolishVersion = process.env.VISUAL_POLISH_VERSION || '20260611-flow40';
