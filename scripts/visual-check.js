...
const expectedAssetVersion = process.env.VISUAL_CHECK_VERSION || '20260615-flow45';
const expectedPolishVersion = process.env.VISUAL_POLISH_VERSION || '20260615-flow45';
