...
const expectedAssetVersion = process.env.VISUAL_CHECK_VERSION || '20260619-finanza2';
const expectedPolishVersion = process.env.VISUAL_POLISH_VERSION || '20260619-finanza2';
